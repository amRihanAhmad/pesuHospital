  ...
  return (
    <div className="dashboard-container animate-fade-in">
      ...
      <div className="dashboard-header">
        <div>
          <h1 className="dashboard-title">Counter Staff Dashboard</h1>
          <p className="dashboard-subtitle">Today's registered patients queue</p>
        </div>
        <button
      ...
      {showManualForm && (
        <div className="hospital-card animate-fade-in-up" style={{ marginBottom: '1.5rem' }}>
          <div className="hospital-card-body">
            <h3 style={{ fontFamily: 'var(--font-heading)', marginBottom: '1rem', fontSize: '1.1rem' }}>
            ...
            <form onSubmit={handleManualRegister} style={{ display: 'flex', gap: '0.75rem', flexWrap: 'wrap', alignItems: 'flex-end' }}>
              ...
              <div className="form-group" style={{ flex: '1 1 160px' }}>
                ...
                <select
                  ...
                  value={manualData.dept}
                  onChange={e => setManualData({ ...manualData, dept: e.target.value })}
                >
      ...
      <div className="dashboard-table-card">
        <div className="table-header">
          <span className="table-title">Patient Queue</span>
        </div>
